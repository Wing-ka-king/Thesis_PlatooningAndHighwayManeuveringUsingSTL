function [uRob,uTraffic,b_final] = lane2_sml(t,robPose, robOrient, trafficPose, trafficOrient, velParam,hypParam,options)
...
d2 = k2*(-(y1-ydes_b)/(abs(y1-ydes_b)+0.001));
t2 = k2*a2;
...
% uRob = [0 u(1,1) u(2,1) 0];
% uTraffic = [0 u2(1,2) u2(1,1) 0];
disp("Following Lane2 constraints")
